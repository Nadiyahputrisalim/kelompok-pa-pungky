                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('kendaraan.index')}}">Kendaraan</a></li>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select" id="pilihCC" name="kapasitas_mesin" value="{{ $row->kapasitas_mesin }}" required>
                                                    ...
                                                    @foreach([50, 110, 125, 150, 200, 250, 300, 400, 500, 600, 750, 1000, 1200, 1300, 1500, 1800, 2000, 2400, 2500, 3000, 3500, 4000, 5000, 7000, 10000] as $cc)
                                                        <option value="{{ $cc }}" {{ old('kapasitas mesin', $row->kapasitas_mesin) == '' ? 'selected' : ''}}>{{ $cc }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-feedback">Tabel Tidak Boleh Kosong!</div>
                                            </div>
                                            ...
                                            <fieldset class="row mb-3 w-100">
                                                ...
                                                <div class="col-sm-10 d-flex align-items-center mt-2">
                                                    <div class="form-check me-3">
                                                        ...
                                                        <div class="invalid-feedback position-absolute">Tabel Tidak Boleh Kosong!</div>
                                                    </div>
